(function () {
    ...
    function buildThemeSelectionQuestion(stepIndex, variant) {
        ...
        return {
            ...
            title: variant === 'primary'
                ? 'Что в целом ощущается самым живым?'
    ...
    function buildTrackSelectionQuestion(stepIndex, themeKey, variant) {
        ...
        return {
            ...
            title: variant === 'primary'
                ...
                : `А внутри темы «${theme?.short || '...' }» что всё ещё кажется живым?`,
            description: variant === 'primary'
        ...
        switch (stepIndex) {
            ...
            case 4:
                return buildAdaptivePromptQuestion(
                    ...
                    'Теперь тест не держится только за два первых выбора. Он собирает несколько живых траекторий и смотрит, где тебе реально хотелось бы оказаться.'
                );
            case 5:
                return buildAdaptivePromptQuestion(
                    stepIndex,
    ...
    function getStepStatus() {
        ...
        return candidates.length
            ? `Сейчас тест держит в фокусе несколько живых траекторий: ${formatList(candidates)}.`
            : '';
    }
